...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_dir", default="resources/data/dataset/ner/en/conll2003/bio", type=str, help="输入文件夹"
    )
    parser.add_argument(
        "--input_type", default="txt", type=str, help="输入文件类型"
    )
    parser.add_argument(
        "--output_dir", default="resources/data/dataset/ner/en/conll2003/json", type=str, help="输出文件夹"
    )
    parser.add_argument(
