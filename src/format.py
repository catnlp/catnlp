...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_dir", default="data/dataset/ner/zh/cluener/json", type=str, help="输入文件夹"
    )
    parser.add_argument(
        "--input_type", default="json", type=str, help="输入文件类型"
    )
    parser.add_argument(
        "--output_dir", default="data/dataset/ner/zh/cluener/bio", type=str, help="输出文件夹"
    )
    parser.add_argument(
        "--output_type", default="txt", type=str, help="输出文件类型"
    )
    parser.add_argument(
        "--convert", default="json2bio", type=str,
        choices=["json2bio", "bio2json", "json2bioes", "bioes2json", "json2clue", "clue2json"], 
        help="转化类型"
    )
