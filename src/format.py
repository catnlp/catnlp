...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_dir", default="resources/data/dataset/ner/zh/ccks/address/0619", type=str, help="输入文件夹"
    )
    parser.add_argument(
        "--input_type", default="txt", type=str, help="输入文件类型"
    )
    parser.add_argument(
        "--output_dir", default="resources/data/dataset/ner/zh/ccks/address/0619", type=str, help="输出文件夹"
    )
    parser.add_argument(
        "--output_type", default="json", type=str, help="输出文件类型"
    )
    parser.add_argument(
        "--convert", default="bio2json", type=str,
