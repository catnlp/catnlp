...
config_file = "resources/config/ner/CMeEE/train_biaffine.yaml"
...
def objective(trial):
    ...
    plm_lr = trial.suggest_categorical("plm_lr", [1e-5, 2e-5, 3e-5])  # trial.suggest_loguniform("plm_lr", 1e-5, 1e-4)
    not_plm_lr = trial.suggest_categorical("not_plm_lr", [5e-5, 1e-4, 5e-3])  # trial.suggest_loguniform("not_plm_lr", 5e-5, 1e-2)
    ...
    num_train_epochs = trial.suggest_int("num_train_epochs", 8, 18)
